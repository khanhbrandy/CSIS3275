...
public class TransactionController {
	...
	@GetMapping("/customers/{customerId}/financial-report")
	public ResponseEntity<FinancialReport>  generateFinancialReport(
			 @RequestParam("startDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate startDate,
		        @RequestParam("endDate") @DateTimeFormat(iso = DateTimeFormat.ISO.DATE) LocalDate endDate, @PathVariable("customerId") long customerId) {
